...
class Upload < ActiveRecord::Base
  attr_accessible :attach,:username,:user_id,:content,:part,:lesson,:unite
  has_attached_file :attach
  validates_attachment_presence :attach, :message => ' Bir Dosya Seçiniz'
  validates :part,:lesson,:unite ,:presence => {:message => ' bölüm/ders/ünite alanları boş bırakılmaz' }
